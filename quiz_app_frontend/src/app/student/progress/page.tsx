    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-yellow-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-4">Loading progress...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="bg-white/80 backdrop-blur-sm shadow-lg border-0">
          <CardHeader>
            ...
            <CardDescription>
              Your complete quiz attempt history and results
            </CardDescription>
          </CardHeader>
          <CardContent>
            {attempts && attempts.length > 0 ? (
                ...
                {attempts.map((attempt) => (
                  ...
                  >
                    <div className="flex-1">
                      <h4 className="font-medium text-lg">{attempt.quiz?.title || 'Quiz'}</h4>
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-gradient mb-2">No Quiz History</h3>
